...
export default function ProcessPage({ lang, setLang }) {
    ...
    return (
        <div style={styles.page}>
            ...
            <motion.div style={{ ...styles.blob, top: -100, right: -100, background: 'radial-gradient(circle, rgba(72, 187, 120, 0.15) 0%, transparent 70%)', y: yBg, rotate: rotateBg }} />
            ...
            <section style={styles.hero} className="hero-section">
                <div style={styles.container}>
                    <motion.div style={{ opacity: opacityHero, position: 'relative', zIndex: 1 }}>
                        ...
                        >
                            <div style={{ whiteSpace: 'pre-wrap' }}>{t.whyProcessTitle}</div>
                        </motion.h1>
            ...
            {/* ================= 2. TRADITIONAL MAKING METHOD (#process) ================= */}
            <Section bg="rgba(255, 237, 213, 0.2)" id="process">
                <div style={styles.grid2Reverse} className="grid-2-reverse">
                    <div className="text-content">
                        <SectionTitle><div className="section-title">{t.whyProcessTitle}</div></SectionTitle>
                        ...
                        <p style={styles.bodyText}>
                            <span style={{ whiteSpace: 'pre-wrap' }}>{t.whyProcessBody3}</span>
                        </p>
                        <p style={styles.bodyText}>
                            {t.whyProcessBody4}
                        </p>
                        <p style={{ ...styles.bodyText, fontWeight: 700, color: '#92400E', marginTop: 24 }}>
                            <span style={{ whiteSpace: 'pre-wrap' }}>{t.whyProcessBody5}</span>
                        </p>
                    </div>
                    <ParallaxCard>
