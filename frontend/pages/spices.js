...
/* ================= PAGE COMPONENT ================= */
export default function SpicesPage({ lang, setLang }) {
    ...
    return (
        <div style={styles.page}>
            ...
            <motion.div style={{ ...styles.blob, top: -100, right: -100, background: 'radial-gradient(circle, rgba(239, 68, 68, 0.15) 0%, transparent 70%)', y: yBg, rotate: rotateBg }} />
            <motion.div style={{ ...styles.blob, top: '40%', left: -200, background: 'radial-gradient(circle, rgba(245, 158, 11, 0.08) 0%, transparent 70%)', y: useTransform(scrollY, [0, 1000], [0, 100]) }} />
            ...
            <section style={styles.hero} className="hero-section">
                <div style={styles.container}>
                    <motion.div style={{ opacity: opacityHero, position: 'relative', zIndex: 1 }}>
                        ...
                        >
                            <div style={{ whiteSpace: 'pre-wrap' }}>{t.whySpicesTitle}</div>
                        </motion.h1>
            ...
            {/* ================= 4. OUR SPICES (#spices) ================= */}
            <Section bg="#fff" id="spices">
                <div style={styles.grid2Reverse} className="grid-2-reverse">
                    <div className="text-content">
                        <SectionTitle><div className="section-title">{t.whySpicesTitle}</div></SectionTitle>
                        <p style={styles.bodyText}>
                            {t.whySpicesBody1}
                        </p>
                        <p style={styles.bodyText}>
                            {t.whySpicesBody2}<br />
                            <span style={{ display: 'block', margin: '8px 0' }}>{t.whySpicesList1}</span>
                            <span style={{ display: 'block', margin: '8px 0' }}>{t.whySpicesList2}</span>
                            <span style={{ display: 'block', margin: '8px 0' }}>{t.whySpicesList3}</span>
                        </p>
                        <p style={{ ...styles.bodyText, fontWeight: 700, color: '#059669', marginTop: 16 }}>
                            <span style={{ whiteSpace: 'pre-wrap' }}>{t.whySpicesBody3}</span>
                        </p>
                        ...
                        <div style={{ marginTop: 24, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                            ...
                            <Badge type="no" text={t.whyCleanNoPreserve || t.whyCleanNoChem} icon="🧪" />
                        </div>
                    </div>
                    <ParallaxCard>
