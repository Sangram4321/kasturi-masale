...
/* ================= PAGE COMPONENT ================= */
export default function HeritagePage({ lang, setLang }) {
    ...
    return (
        <div style={styles.page}>
            <Head>
                <title>{t.whyOriginTitle} | Kasturi Masale</title>
            </Head>

            {/* 🌶️ ANIMATED BACKGROUND BLOBS */}
            <motion.div style={{ ...styles.blob, top: -100, right: -100, background: 'radial-gradient(circle, rgba(165, 42, 42, 0.15) 0%, transparent 70%)', y: yBg, rotate: rotateBg }} />
            <motion.div style={{ ...styles.blob, top: '40%', left: -200, background: 'radial-gradient(circle, rgba(200, 100, 50, 0.08) 0%, transparent 70%)', y: useTransform(scrollY, [0, 1000], [0, 100]) }} />
            ...
            <section style={styles.hero} className="hero-section">
                <div style={styles.container}>
                    <motion.div style={{ opacity: opacityHero, position: 'relative', zIndex: 1 }}>
                        ...
                        >
                            <div style={{ whiteSpace: 'pre-wrap' }}>{t.whyHeritageTitle}</div>
                        </motion.h1>
            ...
            <Section id="origin">
                <div style={styles.grid2} className="grid-2">
                    ...
                    <div style={{ paddingLeft: 20 }} className="text-content">
                        <SectionTitle><div className="section-title">{t.whyHeritageTitle}</div></SectionTitle>
                        ...
                        <p style={styles.bodyText}>
                            <span style={{ whiteSpace: 'pre-wrap' }}>{t.whyHeritageBody3}</span>
                        </p>
                        <p style={{ ...styles.bodyText, marginTop: 24 }}>
                            {t.whyHeritageBody4}
                        </p>
                    </div>
                </div>
